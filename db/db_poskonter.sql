...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Jan 2020 pada 03.36
...
(86, 'I2M', 'ISAT 2 GB MINI', 29250, 31000, 3, 4, 'PCS', 'x'),
...
(109, 'VS30', 'VC SMARTFREN 30GB', 54750, 60000, 1, 2, 'PCS', 'x'),
...
(7, 'admin', 'admin', 'Maula', 'admin'),
(10, 'kasir', 'kasir', 'ichl', 'kasir');
...
--
ALTER TABLE `tb_detailpembelian`
  MODIFY `id_detailbeli` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
